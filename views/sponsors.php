                        ...
                        <div class="row">
                            ...
                            <div class="col m5">
                                ...
                                <p class="brown-text" style="font-size: 14pt">
                                    Fundador da <a href="http://darkmira.fr">Darkmira e Darkmira Brasil</a>; Organizador e Idealizador do <a href="http://darkmiratour.rocks">Darkmira Tour PHP</a>;
                                    Organizador do Symfony Live Brasil;
                                    Professor e coordenador de cursos em Paris;  Empreendedor e Evangelizador de PHP, Segurança e Qualidade.
                                </p>
                    ...
                    <div class="card-content white-text">
                        ...
                        <div class="center">
                            ...
                            <p class="brown-text" style="font-size: 11pt">
                                Nascida e criada no Ceará, a Oowlish Technology é uma empresa em ascensão focada no desenvolvimento de aplicativos e soluções tecnológicas. Seu principal foco de atuação são projetos internacionais, em especial, nos Estados Unidos. Sediada em Porto das Dunas, de frente para o mar.
                            </p>
            ...
            <div class="col s12 m6 offset-m3">
                <div class="card brown lighten-4">
                    <div class="card-content white-text">
                        ...
                        <div class="center">
                        <br>
                            <img class="responsive-img" id="img-sponsors" src="assets/img/sponsors/logo-unichristus.png" alt="UniChristus" title="Centro Universitário Christus">
                        </div>

                    </div>
                    <div class="card-action center">
                        <a class="brown-text text-darken-4" title="website" target="_blank" href="https://www.unichristus.edu.br/"><i class="fa fa-globe fa-3x" aria-hidden="true"></i>
                        </a>
                        <a class="brown-text text-darken-4" title="instagram" target="_blank" href="https://www.instagram.com/unichristus/"><i class="fa fa-instagram fa-3x" aria-hidden="true"></i>
                        </a>
                        <a class="brown-text text-darken-4" title="facebook" target="_blank" href="https://www.facebook.com/Unichristus/"><i class="fa fa-facebook-square fa-3x" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
            </div>
