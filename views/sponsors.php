<div class="container">
       ...
       <div class="row">
          <div class="col s12 m12">
               <div class="icon-block">
                  <h2 class="center font-marron">Patrocinadores e Apoios</h2>
               </div>
          </div>
       </div>
   ...
   <div class="row">
        ...
        <div class="card brown lighten-4">
            ...
            <hr></hr>
            <div class="center">
                <img src="assets/img/sponsors/logo-unifor.png" alt="UNIFOR" title="UNIFOR - Universidade de Fortaleza">
            </div>
           
            </div>
            <div class="card-action">
            <a class="green-text text-darken-4" title="website" target="_blank" href="https://www.unifor.br/"><i class="fa fa-globe fa-3x" aria-hidden="true"></i>
</a>
            <a class="indigo-text" title="twitter" target="_blank" href="https://twitter.com/uniforoficial"><i class="fa fa-twitter-square fa-3x" aria-hidden="true"></i>
</a>
            <a class="indigo-text text-darken-4" title="facebook" target="_blank" href="https://www.facebook.com/uniforoficial/"><i class="fa fa-facebook-square fa-3x" aria-hidden="true"></i>
</a>
            </div>
        </div>
        </div>
